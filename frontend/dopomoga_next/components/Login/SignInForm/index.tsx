...
const SignInForm = () => {
  ...
  const checkLoggedChangeHandler = ()=>{
  ...
  const submitForm = (event)=>{
      ...
      if (enteredFullName.trim().length ===0 || enteredUserName.trim().length ===0 || enteredUserNameEmail.trim().length ===0 || enteredPassword.trim().length ===0 || enteredConfirmPassword.trim().length===0 || !checkLogged)
          {
  ...
  return (
    <div>
      ...
      <form className="row align-items-center main-form" onSubmit={submitForm}>

          <div className="row align-items-center heading p-0">
            <div className="col align-items-center sign-up p-0">Sign In</div>
          ...
          <div className="row justify-content-center line-text">
            ...
            <div className="row line-paragraph">
              <p className="m-0 p-0 text-center">or Sign in with Email</p>
            </div>
          </div>
          ...
          <div className="row align-items-start inputs m-0">
            ...
            <div className="col p-0 ">
              <div className="form-check m-0 d-flex">
                <input className="form-check-input checkbox" checked={checkLogged}  type="checkbox" id="gridCheck" name="logged" onChange={checkLoggedChangeHandler} value={checkLogged} />
          ...
          <div className="col p-0">
            <button type="submit" className="btn btn-primary btn-lg d-flex align-items-center justify-content-center">Sign up<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-right" viewBox="0 0 16 16" >
