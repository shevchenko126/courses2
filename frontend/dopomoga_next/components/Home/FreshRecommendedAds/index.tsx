...
const stack_icon = "/images/icons/Stack.svg";
const map_pin_icon = "/images/icons/MapPin.svg";
const arrow_right_icon = "/images/icons/ArrowRight.svg";

const FreshRecommendedAds = () => {
  return (
    <>
      <div className="FreshRecommendedAds">
        <h2 className="heading01">Fresh recommended ads</h2>
        <div className="container ads d-flex flex-wrap justify-content-start p-0">
          {freshAds.map((card) => (
            <div
              key={card.id}
              className="col-12 col-xxl-3 col-lg-4 col-md-6 col-sm-12 my-2"
            >
              <div
                className={card.highlight ? "ads__card highlight" : "ads__card"}
              >
                <a href="/">
                  <div className="ads__card__image">
                    <div className="ads__card__badge">{card.flag}</div>
                    <img
                      className="ads__card__bg"
                      src={card.image ? card.image : "./d-image.png"}
                      alt="cardImage"
                    />
                  </div>
                  <div className="ads__card__heading">
                    <div className="ads__card__heading__heading">
                      <div className="ads__card__category">
                        <img src={stack_icon} alt="stack" />
                        {card.category}
                      </div>
                      <div className="ads__card__name">{card.name}</div>
                    </div>
                    <div className="ads__card__fun-facts">
                      <div className="fun-facts__location">
                        <img src={map_pin_icon} alt="map_pin" />
                        {card.location}
                      </div>
        ...
        <div className="container ads d-flex justify-content-center">
          <button className="ads__button__view">
            View Alls
            <img src={arrow_right_icon} alt="map_pin" />
          </button>
        </div>
      </div>
    </>
